...
class AlunoController {
  async index(req, res) {
    const alunos = await _Aluno2.default.findAll({
      ...
      order: [['id', 'DESC'], [_Foto2.default, 'id', 'DESC']], // ordenando os alunos pelo id em ordem decrescente e as fotos de cada aluno tambem em ordem decrescente
      include: {
  ...
  async show(req, res) { //pegar um unico aluno
    try {
      ...
      const aluno = await _Aluno2.default.findByPk(id, {
        attributes: ['id', 'nome', 'sobrenome', 'email', 'idade', 'peso', 'altura'],
        order: [['id', 'DESC'], [_Foto2.default, 'id', 'DESC']], // ordenando as fotos do aluno em ordem decrescente pelo id
        include: {
          model: _Foto2.default,
          attributes: ['filename', 'url'],
        },
  ...
  async delete(req, res) {try {
      ...
      const aluno = await _Aluno2.default.findByPk(id); //procurar o aluno pelo id
